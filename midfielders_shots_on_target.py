"""Midfielders Shots on Target.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1SCu3alPEvNaIMEs4kThdzadAUw2kXahU
"""
...
# Read Data from csv
dfBest = pd.read_csv('Midfielders.csv')
dfBest_y = dfBest['Shots On Target']
...
def processPlayersData(samples, dfBest):
   ...
   #Midfield Top 50
		if (dfBest['Position'][i] == 'Midfielder'):
			samples.insert(i,[dfBest['Age'][i],dfBest['Appearances'][i],dfBest['Goal Assists'][i]])
