"""Defenders Goals Conceded.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/17ShyQ1Sb43xvPCxkazQXMldqHPL6a15I
"""
...
# Read Data from csv
dfBest = pd.read_csv('Defenders.csv')
dfBest_y = dfBest['Goals Conceded']
...
def processPlayersData(samples, dfBest):
	...
	for i in range(dfBestSize):
		#Defence Attributtes
		if (dfBest['Position'][i] == 'Defender'):
			samples.insert(i,[dfBest['Age'][i],dfBest['Appearances'][i],dfBest['Fouls Committed'][i]])
